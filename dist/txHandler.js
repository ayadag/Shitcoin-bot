...
var send_bundle_1 = require("./jito_bundle/send-bundle");
var log = console.log;
...
function createToken(input) {
    return __awaiter(this, void 0, void 0, function () {
        var decimals, name_1, image, symbol, website, telegram, twitter, url, initialMintingAmount, description, metadata, keypair, wallet, endpoint, baseMpl, ipfsHash, hash, uri, res, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    decimals = input.decimals, name_1 = input.name, image = input.image, symbol = input.symbol, website = input.website, telegram = input.telegram, twitter = input.twitter, url = input.url, initialMintingAmount = input.initialMintingAmount, description = input.description;
                    metadata = {};
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_l) {
            switch (_l.label) {
                ...
                case 4:
                    _a = _l.sent(), userAccountInfo = _a[0], ataInfo = _a[1];
                    if (!userAccountInfo)
                ...
                case 6:
                    _b = _l.sent(), userAccountInfo = _b[0], ataInfo = _b[1];
                    if (!userAccountInfo)
                        return [2 /*return*/, { Err: "wallet dosen't have enought Sol to create pool" }];
                    balance = (0, utils_1.calcDecimalValue)(userAccountInfo.lamports, 9);
                    if (balance < poolSolFund)
                ...
                case 9:
                    createPoolRecentBlockhash = (_j = (_l.sent())) === null || _j === void 0 ? void 0 : _j.blockhash;
                ...
                case 11:
                    buyRecentBlockhash = (_k = (_l.sent())) === null || _k === void 0 ? void 0 : _k.blockhash;
                    ...
                    _d = (_c = console).log;
                    _e = ["createpoolTX ===>"];
                    return [4 /*yield*/, connection.simulateTransaction(createPoolTx)];
                case 12:
                    // {
                    //     const createPoolRes = await connection.sendTransaction(createPoolTx)
                    //     log({ createPoolRes })
                    ...
                    _g = (_f = console).log;
                    _h = ["buy ====>"];
                    return [4 /*yield*/, connection.simulateTransaction(buyTx)];
                case 13:
                    _g.apply(_f, _h.concat([_l.sent()]));
                    return [4 /*yield*/, (0, send_bundle_1.bull_dozer)(connection, createPoolTx, buyTx)];
                case 14:
                    res = _l.sent();
