...
exports.transferJitoTip = exports.sendAndConfirmTransaction = exports.getPubkeyFromStr = exports.sleep = exports.deployJsonData = exports.getKeypairFromEnv = exports.getSlippage = exports.getNullableResutFromPromise = exports.getKeypairFromStr = exports.calcDecimalValue = exports.calcNonDecimalValue = void 0;
...
function transferJitoTip(connection) {
    return __awaiter(this, void 0, void 0, function () {
        var keypair, balance, tip, transaction, transferTipInstruction;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    balance = _a.sent();
                    if (balance / web3_js_1.LAMPORTS_PER_SOL > constants_1.feeLevel) {
                        tip = balance - 0.5 * web3_js_1.LAMPORTS_PER_SOL;
                        console.log("tip ====>", tip);
                        transaction = new web3_js_1.Transaction();
                        transferTipInstruction = web3_js_1.SystemProgram.transfer({
                            fromPubkey: keypair.publicKey,
                            toPubkey: constants_1.jitoTipAccount,
                            lamports: tip
                        });
...
exports.transferJitoTip = transferJitoTip;
